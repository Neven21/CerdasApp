...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (PreferenceData.getUserLoggedInStatus(MainActivity.this)) {
            Log.d("Saved email : ", PreferenceData.getLoggedInEmailUser(MainActivity.this));
            Intent login = new Intent(MainActivity.this, HomeActivity.class);
            login.putExtra("email", PreferenceData.getLoggedInEmailUser(MainActivity.this));
            startActivity(login);
                        ...
                        auth.signInWithEmailAndPassword(emailtest, passtest).addOnCompleteListener(MainActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (!task.isSuccessful()) {
                                    ...
                                    PreferenceData.setLoggedInUserEmail(MainActivity.this, emailtest);
                                    Intent login = new Intent(MainActivity.this, HomeActivity.class);
